...
public class AdapterGeneratorImplementation implements AdapterGenerator {

    private static final String NAME_TEMPLATE = "ru.otus.adapter.%sAdapter";
    ...
    public <T> T resolve(Class<T> interfaceType, UObject uObject) {
        try {
            ...
            return adapter.create(uObject).get();
        } catch (Throwable e) {
